...
@misc{ 
  author = {Chanwoong joo},
  howpublished = {GitHub},
  title = Super Mario Bros RL,
  URL = {https://github.com/jcwleo/mario_rl.git},
  year = {2018},
}
'"""""
################################################################################################################################################
...
class NoisyLinear(nn.Module):
    ...
    " The method basically consists of adding the gaussian noise to the last (fully-connected) layers of the network. "
    "Parameters of this noise can be adjusted by the model during training, which allows the agent to decide when" 
    "and in what proportion it wants to introduce the uncertanty in it’s weights."
...
class CnnActorCriticNetwork(nn.Module):
    def __init__(self, input_size, output_size, use_noisy_net=False):
        ...
        #critic will return value
        #actor return set of possible actions
